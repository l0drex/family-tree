                        ...
                        <p>
                            {translationToString({
                                en: <>The file must be a valid GedcomX file in json format,
                                    as described <a href="https://github.com/FamilySearch/gedcomx/blob/master/specifications/json-format-specification.md">here</a></>,
                                de: <>Die Datei muss eine gültige GedcomX Datei im json Format sein,
                                    wie <a href="https://github.com/FamilySearch/gedcomx/blob/master/specifications/json-format-specification.md">hier</a> beschrieben.</>
                            })}

    ...
    .addPerson(getPerson("husband", "male")
      ...
      .addName(new Name()
        .addNameForm(new NameForm()
          .addPart(new NamePart()
            .setValue("Sir")
            .setType(NamePartTypes.Prefix)
            .addQualifier(new Qualifier().setName(NamePartQualifier.Title)))
          .addPart(new NamePart()
            .setValue("William")
            .setType(NamePartTypes.Given)
            .addQualifier(new Qualifier().setName(NamePartQualifier.Primary))
            .addQualifier(new Qualifier().setName(NamePartQualifier.RootName).setValue("William")))
          .addPart(new NamePart()
            .setValue("von")
            .addQualifier(new Qualifier().setName(NamePartQualifier.Particle)))
          .addPart(new NamePart()
            .setValue("Gutenberg")
            .setType(NamePartTypes.Surname)
            .addQualifier(new Qualifier().setName(NamePartQualifier.Family)))))
